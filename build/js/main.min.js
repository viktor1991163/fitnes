...
/* harmony import */ var _modules_tab__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/tab */ "./js/modules/tab.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_video__WEBPACK_IMPORTED_MODULE_1__["initPlay"])();
  Object(_modules_tab__WEBPACK_IMPORTED_MODULE_2__["initTab"])();
});
...
var tabLinks = document.querySelectorAll('.products__item-time');
var initTab = function initTab() {
  ...
  function openTabs(el) {
    if (el.code === 'Enter' || el.code === 'Space' || el.button === 0) {
      var tabLinkss = document.querySelectorAll('.products__item-time');
      var tabContent = document.querySelectorAll('[data-money]');
      var btnTarget = el.currentTarget;
      var long = btnTarget.dataset.long;
      tabLinkss.forEach(function (e) {
        e.classList.remove('products__item-time--active');
      });
      tabContent.forEach(function (e) {
        e.classList.remove('active');
      });
      var tabContentActive = document.querySelectorAll("[data-money='".concat(long, "']"));
      tabContentActive.forEach(function (e) {
...
/*!*****************************!*\
  !*** ./js/modules/video.js ***!
  \*****************************/
/*! exports provided: initPlay */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPlay", function() { return initPlay; });
var button = document.querySelector('.promo__btn');
var videoHolder = document.querySelector('.promo__video-wrapper');
var imgPrev = document.querySelector('.promo__video-img');
var overlay = document.querySelector('.promo__video-overlay');
