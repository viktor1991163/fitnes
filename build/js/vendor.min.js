...
var slider = new Swiper('.comments__swiper', {
  spaceBetween: 405,
  navigation: {
...
var slide = new Swiper('.coaches__swiper', {
...
var slideDouble = document.querySelectorAll('.swiper-slide-duplicate');
slideDouble.forEach(function (el) {
